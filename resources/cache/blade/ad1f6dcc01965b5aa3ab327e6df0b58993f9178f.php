                    ...
                    <div class="post-status">
                        ...
                        <div class="manga-action" ng-controller="userFunction" ng-init="getstatus(<?php echo e($manga->id); ?>)">
                            <div class="bookmark-btn wleft" ng-cloak>
                                ...
                                $x = "{{bkresult.message}}";
                                ?>
                                <div class="bknotice tcenter"><?php echo e($x); ?></div>
                            </div>
                            <div class="readbtn wleft">
                                <?php if(!empty($chapters)): ?>
                                    <a class="rfirst tcenter" href="<?php echo e(url("chapter", [ 'm_slug' => $manga->slug, 'c_slug' => $chapters[count($chapters) - 1]->slug, 'c_id' => $chapters[count($chapters) - 1]->id])); ?>">
                                        <?php echo e(L::_("Read First")); ?>

                                    </a>
                                    <a class="rlast tcenter" href="<?php echo e(url("chapter", [ 'm_slug' => $manga->slug, 'c_slug' => $chapters[0]->slug, 'c_id' => $chapters[0]->id])); ?>">
...
</div><?php /**PATH /www/wwwroot/truyenhaybl.com/resources/views/themes/manhwa18cc/components/manga/profile.blade.php ENDPATH**/ ?>