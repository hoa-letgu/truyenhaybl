        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php echo e(L::_('Terms of service')); ?></li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container">
            <section class="block_area block_area-infor">
                ...
                <article class="article-infor">
                    ...
                    <p>Bằng cách truy cập Trang web này từ <a href="<?php echo e(url('home')); ?>"><?php echo e(url('home')); ?></a>,
...
<?php echo $__env->make('themes.mangareader.layouts.full', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/hoimetruyen.com/resources/views/themes/mangareader/pages/terms.blade.php ENDPATH**/ ?>