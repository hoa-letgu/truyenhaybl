                        ...
                        <div class="card">
                            <div class="card-header position-relative"><h3 class="card-title mt-1"><i
                                ...
                                <div class="card-tools">
                                    <a href="<?php echo e(url('admin.manga-add')); ?>" class="btn btn-sm btn-success"><i
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <table id="table"
                                                ...
                                                <?php $__currentLoopData = $mangas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manga): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr class="group-item" data-id="<?php echo e($manga->id); ?>"
                                                        data-name="<?php echo e($manga->name); ?>">
                                                        ...
                                                        <td width="120px" class="text-center align-middle">
                                                            <img width="100%" src="<?php echo e($manga->cover); ?>">
                                                        </td>
                                                        <td class="item-edit"
                                                            onclick="window.location = ('<?php echo e(url('admin.manga-edit', ['m_id' => $manga->id])); ?>');">
                                                            <div class="w-100">
                                                                <strong>
                                                                    <span class="text-info"><?php echo e($manga->name); ?> </span>
                                                                    <?php if($manga->adult === 1): ?>
                                                                        <span class="ml-1 mb-1 badge badge-danger">18+</span>
                                                                    <?php endif; ?>
                                                                    <span class="ml-1 mb-1 badge badge-warning"><?php echo e($manga->views); ?> lượt xem</span>
                                                                </strong>
                                                            </div>
                                                            <div class="w-100">
                                                                <strong><?php echo e((get_manga_data('chapters', $manga->id)[0]->name ?? 'Chưa có chap')); ?></strong><span
                                                                        class="ml-2 mb-1 badge badge-info"><?php echo e(timeago($manga->last_update)); ?></span>
                                                            </div>
                                                            <div class="w-100">
                                                                ...
                                                                <?php $__currentLoopData = (get_manga_data('artists', $manga->id, [])); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $artist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <span class="mr-2 mb-1 badge badge-primary"><?php echo e($artist->name); ?></span>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </div>
                                                        </td>
                                                        <td class="text-center" width="180px">
                                                            <a href="<?php echo e(url('admin.chapter-add', ['m_id' => $manga->id])); ?>"
                                                               type="button"
                                                            ...
                                                            <a type="button"
                                                               href="<?php echo e(url('admin.manga-edit', ['m_id' => $manga->id])); ?>"
                            ...
                            <div class="card-footer clearfix">
                                <ul class="pagination m-0 float-right">
                                    <li class="page-item <?php echo e($page <= 1 ? 'disabled' : ''); ?>">
                                        <a class="page-link " href="<?php echo e(url(null, null, ['page' => $page - 1])); ?>">«</a>
                                    </li>
                                    <?php if($page > 1): ?>
                                        <li class="page-item">
                                            <a class="page-link"
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/truyenhaybl.com/resources/views/admin/components/manga_manage/user.blade.php ENDPATH**/ ?>