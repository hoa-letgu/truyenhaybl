<div class="sidebar-panel wleft">
    <div class="sidebar-title popular-sidebartt wleft">
        <h2 class="sidebar-pn-title"><?php echo e(L::_("POPULAR MANHWA")); ?></h2>
    </div>
    <div class="sidebar-pp wleft">
        <?php $__currentLoopData = (new Models\Manga())->trending_manga(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manga): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="p-item">
                <a class="pthumb" href="<?php echo e(url('manga', ['m_slug' => $manga->slug, 'm_id' => $manga->id])); ?>" title="<?php echo e($manga->name); ?>">
                    ...
                    <div class="listsb-chapter">
                        <?php $__currentLoopData = array_slice(get_manga_data('chapters', $manga->id),0,2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chapter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="chapter-item wleft">
                                                <span class="chapter">
                                                    <a href="<?php echo e(url('chapter', ['m_slug' => $manga->slug, 'c_slug' => $chapter->slug, 'c_id' => $chapter->id ])); ?>" class="btn-link" title="<?php echo e($manga->name); ?> <?php echo e($chapter->name); ?>"> <?php echo e($chapter->name); ?> </a>
                                                </span>
...
</div><?php /**PATH /www/wwwroot/truyenhaybl.com/resources/views/themes/manhwa18cc/components/popular-sidebar.blade.php ENDPATH**/ ?>