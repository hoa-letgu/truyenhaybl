...
<?php $__env->startSection('title', 'Đăng Truyện Lên Website Hoimetruyen.com'); ?>
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php echo e(L::_('Đăng Truyện Lên Website Hoimetruyen.com')); ?></li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container">
            <section class="block_area block_area-infor">
                ...
                <article class="article-infor">
                    ...
                    <strong> NẾU ĐÃ ĐỒNG Ý VỚI CÁC ĐIỀU KHOẢN Ở TRÊN BẠN CÓ THỂ ĐĂNG KÝ <a class="text-bold" href="<?php echo e(url('user.request-permission')); ?>"> TẠI ĐÂY</a></strong>
                </article>
            </section>
        </div>
    </div>
...
<?php echo $__env->make('themes.mangareader.layouts.full', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/hoimetruyen.com/resources/views/themes/mangareader/pages/request-detail.blade.php ENDPATH**/ ?>