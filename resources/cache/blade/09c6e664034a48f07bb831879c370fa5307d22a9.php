        ...
        <div class="block_area-content">
            <div class="menu-profiles">
                <ul class="ulclear">
                    ...
                    <li class="<?php echo e($active); ?>">
                        <a href="/user/notification" class="mp-item"><i class="fas fa-bell mr-3"></i><?php echo e(L::_('Notifications')); ?></a>
                    </li>
                </ul>
            </div>
        </div>
    </section>
</div><?php /**PATH /www/wwwroot/truyenhaybl.com/resources/views/themes/mangareader/components/user/main-sidebar.blade.php ENDPATH**/ ?>