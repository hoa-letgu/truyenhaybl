    ...
    <div class="centernav">
        <div class="site-body">
            ...
            <div class="mb-4 manage-menu">
                <a href="<?php echo e(url("admin.chapter-add", ['m_id'=> $manga->id])); ?>" class="btn mr-2"> <i
                        class="icofont-upload"></i> Thêm chương</a>
                <a href="<?php echo e(url("admin.manga-edit", ['m_id'=> $manga->id])); ?>" class="btn"> <i
                        class="icofont-edit"></i> Sửa truyện</a>
            ...
            <div class="content-manga-left">
                <div class="panel-story-description">
                    ...
                    <div class="dsct">
                        ...
                        <?php else: ?>
                        <p>
                            <?php echo $metaConf['manga_description']; ?>
                ...
                <div class="panel-manga-chapter " id="chapterlist">
                    <h2 class="manga-panel-title "><i class="icofont-flash"></i> <?php echo e(L::_("Latest Chapter Releases")); ?>
                ...
                <div class="manga-tags ">
                    ...
                    <div class="tags_list">
                        <?php
                        $tags = get_manga_data('tags', $manga->id, []);
                        ?>

                        <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(url('tag', ['t_slug' => $tag->slug, 't_id' => $tag->id])); ?>" itemprop="keywords"
                            title="<?php echo e($tag->name); ?>"><?php echo e($tag->name); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                            ...
                            <div class="rlbsx">
                                <div class="thumb">
                                    <a href="<?php echo e(url('manga', ['m_slug' => $manga->slug, 'm_id' => $manga->id])); ?>"
                                        ...
                                        <img data-src="<?php echo e($manga->cover); ?>" src="<?php echo e($manga->cover); ?>"
                                        ...
                                        <div class="chapter-item">
                                            <span class="chapter">
                                                <a href="<?php echo e(url('chapter', ['m_slug' => $manga->slug, 'c_slug' => $chapter->slug, 'c_id' => $chapter->id ])); ?>"
                                                    class="btn-link" title="<?php echo e($manga->name); ?> <?php echo e($chapter->name); ?>"> <?php echo e($chapter->name); ?><?php if($chapter->name_extend): ?> - <?php echo e($chapter->name_extend); ?> <?php endif; ?></a>
                                            </span>
...
<style>
    .panel-manga-chapter ul li a.isread,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.manga18fx.layouts.full', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/truyenhaybl.com/resources/views/themes/manga18fx/pages/manga.blade.php ENDPATH**/ ?>