                                ...
                                <div class="genres-content">
                                    <?php $__currentLoopData = get_manga_data('genres', $manga->id, []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $genre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(url('genres', ['genres' => $genre->slug])); ?>"
                                           class="badge bg-secondary pt-2 pb-2 pl-3 pr-3 mt-1 mr-1 mb-1 text-uppercase" itemprop="genre"><?php echo e($genre->name); ?></a>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                        </div>
...
</div><?php /**PATH /www/wwwroot/truyenhaybl.com/resources/views/themes/manga18fx/components/manga/profile.blade.php ENDPATH**/ ?>