...
<?php $__env->startSection('title', 'Truyện Hay BL - Điều khoản và dịch vụ'); ?>
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php echo e(L::_('DMCA')); ?></li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container">
            <section class="block_area block_area-infor">
                ...
                <article class="article-infor">
                    ...
                    <p></p>
                    <p>Yêu cầu gỡ xuống DMCA của bạn phải được gửi tại đây: <a href="/contact"><?php echo e(url('contact')); ?></a></p>
...
<?php echo $__env->make('themes.mangareader.layouts.full', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/truyenhaybl.com/resources/views/themes/mangareader/pages/dmca.blade.php ENDPATH**/ ?>