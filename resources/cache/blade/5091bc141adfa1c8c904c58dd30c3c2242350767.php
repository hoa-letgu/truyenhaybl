                    ...
                    <div class="modal-body">
                        ...
                        <form class="preform" id="login-form" method="post" name="login-form">
                            ...
                            <div class="form-group login-btn mt-4 mb-2">
                                ...
                                <a href="<?php echo e((new Services\GoogleLogin())->getAuthUrl()); ?>" class="btn btn-primary btn-block">Google Login</a>
...
<?php /**PATH /www/wwwroot/truyenhaybl.com/resources/views/themes/mangareader/components/modal-login.blade.php ENDPATH**/ ?>