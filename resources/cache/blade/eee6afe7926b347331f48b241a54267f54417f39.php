    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="mailto:@gmai.com" class="nav-link">Contact</a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?php echo e(url('admin')); ?>" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Admin Truyện Hay BL</span>
            </a>
...
</html><?php /**PATH /www/wwwroot/truyenhaybl.com/resources/views/admin/layout.blade.php ENDPATH**/ ?>