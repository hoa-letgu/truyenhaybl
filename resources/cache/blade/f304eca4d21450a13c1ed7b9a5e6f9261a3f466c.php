<?php if(!is_login()): ?>
    <div class="user-block tright" ng-controller="userFunction">
        <div class="guest-option">
            <a href="<?php echo e(url("user.login")); ?>"><?php echo e(L::_("Sign In")); ?></a>
            <a href="<?php echo e(url("user.register")); ?>"><?php echo e(L::_("Sign Up")); ?></a>
        </div>
    </div>
<?php else: ?>
    <div class="user-block tright ng-scope" ng-controller="userFunction">
        <div class="box-user-options">
            <div class="c-user_avatar">
                <a href="<?php echo e(url("user.reading-list")); ?>">
            ...
            <div class="user-logout">
                <a href="<?php echo e(url("logout")); ?>" data-method="get">
...
<?php endif; ?><?php /**PATH /www/wwwroot/truyenhaybl.com/resources/views/themes/manhwa18cc/components/user-block.blade.php ENDPATH**/ ?>