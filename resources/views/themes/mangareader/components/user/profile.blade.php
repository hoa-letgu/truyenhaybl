    ...
    <section class="block_area block_area_profile">
        <div class="block_area-header">
            <div class="bah-heading">
                <h2 class="cat-heading">{{ L::_('Profile Manager') }}</h2>
            </div>
        ...
        <div class="block_area-content">
            <form class="preform preform-center" method="post" id="profile-form">
                <div class="profile-avatar">
                    <img data-toggle="modal" data-target="#modalavatars" id="preview-avatar" src="{{ userget()->avatar_url }}" alt="{{ userget()->name }}">
                    <div data-toggle="modal" data-target="#modalavatars" class="pa-edit">{{ L::_('Change Avatar') }}
                    </div>
                </div>
                <div class="form-group">
                    <label class="prelabel" for="pro5-email">Email address</label>
                    <input type="email" class="form-control" disabled="" id="pro5-email" value="{{ userget()->email }}">
                </div>
                <div class="form-group">
                    <label class="prelabel" for="pro5-name">Display name</label>
                    <input type="text" class="form-control" id="pro5-name" required="" name="name" value="{{ userget()->name }}">
                </div>
                <div class="block">
