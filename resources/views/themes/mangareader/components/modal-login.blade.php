                    ...
                    <div class="modal-body">
                        ...
                        <form class="preform" id="login-form" method="post" name="login-form">
                            ...
                            <div class="form-group login-btn mt-4 mb-2">
                                ...
                                <a href="{{ (new Services\Fb())->getFB()->getRedirectLoginHelper()->getLoginurl(url('fb-callback'), ['email']) }}" class="btn btn-primary btn-block">Facebook Login</a>
                                <a href="{{ (new Services\GoogleLogin())->getAuthUrl() }}" class="btn btn-primary btn-block">Google Login</a>
