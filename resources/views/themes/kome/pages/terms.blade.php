...
@section('title',  getConf('meta')['site_name'] . ' - '. L::_("Terms of service"))
    ...
    <div class="container">
        <section class="mt-4 mb-4">
            ...
            <article class="article-infor">
                ...
                <p>By accessing this Website, accessible from <a href="{{ url("home") }}">{{ url("home") }}</a>, you are agreeing to be bound by these
                ...
                <p>Permission is granted to temporarily download one copy of the materials on {{ getConf('meta')['site_name'] }}'s Website
                ...
                <ul>
                    ...
                    <li>attempt to reverse engineer any software contained on {{ getConf('meta')['site_name'] }}'s Website;</li>
                    <li>remove any copyright or other proprietary notations from the materials; or</li>
                    <li>transferring the materials to another person or "mirror" the materials on any other
                        server.
                    </li>
                </ul>
                <p>This will let {{ getConf('meta')['site_name'] }} to terminate upon violations of any of these restrictions. Upon
                ...
                <p>All the materials on {{ getConf('meta')['site_name'] }}’s Website are provided "as is". {{ getConf('meta')['site_name'] }} makes no warranties,
                    may it be expressed or implied, therefore negates all other warranties. Furthermore, {{ getConf('meta')['site_name'] }}
                ...
                <p>{{ getConf('meta')['site_name'] }} or its suppliers will not be hold accountable for any damages that will arise with the
                    use or inability to use the materials on {{ getConf('meta')['site_name'] }}’s Website, even if {{ getConf('meta')['site_name'] }} or an
                ...
                <p>The materials appearing on {{ getConf('meta')['site_name'] }}’s Website may include technical, typographical, or
                    photographic errors. {{ getConf('meta')['site_name'] }} will not promise that any of the materials in this Website are
                    accurate, complete, or current. {{ getConf('meta')['site_name'] }} may change the materials contained on its Website at
                    any time without notice. {{ getConf('meta')['site_name'] }} does not make any commitment to update the materials.</p>
                <h4 class="h4-heading">6. Links</h4>
                <p>{{ getConf('meta')['site_name'] }} has not reviewed all of the sites linked to its Website and is not responsible for the
                ...
                <p>{{ getConf('meta')['site_name'] }} may revise these Terms of Use for its Website at any time without prior notice. By
                ...
                <p>Any claim related to {{ getConf('meta')['site_name'] }}'s Website shall be governed by the laws of bq without regards to
