...
@section('title', L::_("Login") . ' - ' .getConf('meta')['site_name'])
        ...
        <div class="wrap-content-part">
            <div class="header-content-part">
                <div class="title text-center"
                     style="width: 100%; font-size: 1.3rem !important;">{{ L::_("Login") }}</div>
            </div>
            <div class="body-content-part" style="min-height:700px;">
                ...
                <form id="login-form" action="/ajax/auth/login" method="POST">
                    <div class="wrap-form-input">
                        ...
                        <div class="wrap-input">
                            <div class="wr-input">
                                <button class="btn btn-secondary" type="submit">{{ L::_("Login") }}</button>
                                <label class="checkbox">
                                    <input id="isRemember" name="isRemember" type="checkbox"
                                           value="2">{{ L::_("Remember me") }}</label></div>
                            <div class="wr-input">
                                <a class="pull-left"
                                   href="{{ url("register") }}">{{ L::_("Register") }}</a>
                                <a class="pull-right" href="{{ url("forgot") }}">{{ L::_("Forgot password") }}?</a>
                                <br class="clear"></div>
                         </div>
                    </div>
                </form>
