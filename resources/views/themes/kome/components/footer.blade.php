<div id="footer" class="footer-dark">
    <footer>
        <div class="container">
            <div class="row">
                ...
                <div class="col-6 col-sm-6 col-md-3 item"><h3>MENU</h3>
                    <ul>
                        ...
                        <li class="mt-3"><a href="{{ url("sitemap.xml") }}">Sitemap</a></li>
                        <li class="mt-3"><a href="{{ url("rss") }}">RSS</a></li>
                    </ul>
                </div>
                <div class="col-6 col-sm-6 col-md-3 item"><h3>HELPFUL LINKS</h3>
                    <ul>
                        <li class="mt-3"><a href="{{ url("terms") }}">Terms of service</a></li>
            ...
            <p class="copyright">{{ $metaConf['site_name'] }} © 2019 - {{ date('Y') }}</p></div>
    </footer>
</div>