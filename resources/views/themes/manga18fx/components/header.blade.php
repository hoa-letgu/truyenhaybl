...
<div class="header-manga pc-header ">
    <div class="header-top ">
        <div class="centernav">
            <div class="logo">
                <a  href="{{ url("home") }}">
                    <img src="/manga18fx/images/logo.png">
                </a>
            </div>
            <div class="top-menu">
                <div class="left-menu">
    ...
    <div class="header-bottom ">
        <div class="centernav">
            <ul>
                ...
                @endif
                <li>
                    <a href="{{ path_url("manga.history") }}"
                       class="text-danger"
                       title="{{ L::_("History") }}"><i class="icofont-history"></i> {{ L::_("History") }}</a>
                </li>
                <li>
                    <a href="{{ url("completed") }}"
                       title="{{ L::_("Completed") }}"> {{ L::_("Completed") }}</a>
                </li>
                <li>
                    <a href="{{ url("most-viewed") }}"
                       title="{{ L::_("Most Viewed") }}"> {{ L::_("Most Viewed") }}</a>
                </li>
                <li class="dropdownmenu">
                    <a href="#" title="{{ L::_("Genres") }}">
...
<div class="header-manga mb-header ">
    ...
    <div class="under-header">
        <div class="header-menu" style="display: none;">
            <ul>
                <li>
                    <a href="{{ url('home') }}" title="{{ L::_("Home") }}"><i
                                class="icofont-home"></i> {{ L::_("Home") }}</a>
                </li>
                <li>
                    <a href="{{ url("manga_list") }}"
                       title="{{ L::_("All Manga") }}">{{ L::_("All Manga") }}</a>
                </li>
                <li>
