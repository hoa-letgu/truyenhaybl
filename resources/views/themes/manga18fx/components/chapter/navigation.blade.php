<div class="chap-navigation wleft tcenter">
    ...
    <div class="navi-change-chapter-btn">
        <a class="navi-change-chapter-btn-prev a-h" href="#"><i class="icofont-swoosh-left"></i> {{ L::_("PREV CHAPTER") }}</a>
        <a class="navi-change-chapter-btn-next a-h" href="#">{{ L::_("NEXT CHAPTER") }} <i class="icofont-swoosh-right"></i></a>
    </div>
</div>